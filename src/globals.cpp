...
byte lfoLast[3];
byte fatMode = 0;
int lfoCut1, lfoCut2, lfoCut3, cutBase, lfoSpeedLfo1, lfoSpeedLfo2, lfoSpeedLfo3, lfoSpeedLfo4, lfoSpeedLfo5,
...
int pw1, pw2, pw3, pw1Base, pw2Base, pw3Base, pw1Lfo1, pw1Lfo2, pw1Lfo3, pw2Lfo1, pw2Lfo2, pw2Lfo3, pw3Lfo1, pw3Lfo2,
    pw3Lfo3;
float fineBase1, fineBase2, fineBase3, fine1, fine2, fine3, lfoFine1, lfoFine2, lfoFine3, lfoFine4, lfoFine5, lfoFine6,
...
int lfoButtTimer;
bool heldKeys[128];
int arpSpeed, arpSpeedBase, arpSpeedLfo1, arpSpeedLfo2, arpSpeedLfo3, arpRange, arpStep;
