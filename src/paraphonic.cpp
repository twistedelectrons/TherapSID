...
pw2Base=pw3Base=pw1Base;tuneBase2=tuneBase3=tuneBase1;fineBase2=fineBase3=fineBase1;glide2=glide3=glide1;
a2=a3=a1;d2=d3=d1;r2=r3=r1;s2=s3=s1;sid[12]= 255 & a2<<4;sid[12]=  sid[12] | d2;sid[19]= 255 & a3<<4;sid[19]=  sid[19] | d3;
a2=a3=a1;d2=d3=d1;r2=r3=r1;s2=s3=s1;sid[13]= 255 & s2<<4;sid[13]=  sid[13] | r2;sid[20]= 255 & s3<<4;sid[20]=  sid[20] | r3;
paraShape();
 ...
 digit(0,99);digit(1,99);load(preset);break;
