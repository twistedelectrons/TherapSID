...
byte temp;
 ...
 if(jumble){
  ...
  if(dice==0){sid[4]=B00000000;} 
  else if(dice==1){sid[4]=B01000000;} 
  else if(dice==2){sid[4]=B00100000;} 
  else if(dice==3){sid[4]=B00010000;}  
  else if(dice==4){sid[4]=B10000000;}
  
   dice=random(0,5);
   if(dice==0){sid[11]=B00000000;} 
  else if(dice==1){sid[11]=B01000000;} 
  else if(dice==2){sid[11]=B00100000;} 
  else if(dice==3){sid[11]=B00010000;}  
  else if(dice==4){sid[11]=B10000000;}
  
   dice=random(0,5);
   if((!dice)&&(!sid[4])&&(!sid[11]))dice++;
  if(dice==0){sid[18]=B00000000;} 
  else if(dice==1){sid[18]=B01000000;} 
  else if(dice==2){sid[18]=B00100000;} 
  else if(dice==3){sid[18]=B00010000;}  
  else if(dice==4){sid[18]=B10000000;}
  
   dice=random(0,5);
   if(dice==0){bitWrite(sid[4],1,1);} 
   if(dice==1){bitWrite(sid[4],2,1);} 
   if(dice==2){bitWrite(sid[11],1,1);} 
   if(dice==3){bitWrite(sid[11],2,1);} 
   if(dice==4){bitWrite(sid[18],1,1);} 
   if(dice==5){bitWrite(sid[18],2,1);} 
 }
...
if(fatMode>3){fatMode=0;}
 ...
 fineBase1=ready();fineBase1/=255;
 fineBase2=ready();fineBase2/=255;
 fineBase3=ready();fineBase3/=255;
...
shape1Pressed=false;shape1PressedTimer=0;

tuneBase1=constrain(tuneBase1,0,24);
tuneBase2=constrain(tuneBase2,0,24);
tuneBase3=constrain(tuneBase3,0,24);

pw1Base=ready();pw1Base=pw1Base<<3;
pw2Base=ready();pw2Base=pw2Base<<3;
pw3Base=ready();pw3Base=pw3Base<<3;

glide1=ready();glide1=constrain(glide1,0,63);
glide2=ready();glide2=constrain(glide2,0,63);
glide3=ready();glide3=constrain(glide3,0,63);

if(jumble){if(random(20)>15){glide1=random(63);}else{glide1=0;}}
if(jumble){if(random(20)>15){glide2=random(63);}else{glide2=0;}}
if(jumble){if(random(20)>15){glide3=random(63);}else{glide3=0;}}
 ...
 bitWrite(lfoShape[1],0,bitRead(temp,7));
  ...
  if(jumble){
    for(int i=0;i<20;i++){
       ...
       lfoAss[0][i]=0;lfoAss[1][i]=0;lfoAss[2][i]=0;
    }
    
    for(int i=0;i<20;i++){
     if(random(20)>15){lfoAss[0][random(19)]=1;}
     if(random(20)>15){lfoAss[1][random(19)]=1;}
     if(random(20)>15){lfoAss[2][random(19)]=1;}
    }
...
arpCount=0;
cutBase=ready()<<2;
arpSpeedBase=ready();if(arpSpeedBase==0)arpSpeedBase=1;
...
for(int i=0;i<25;i++){sidLast[i]=255-sid[i];}
...
void writey(byte data){
   ...
   EEPROM.write(writeIndex,data);writeIndex++;
}

int ready(){
  
  
   byte data=EEPROM.read(writeIndex);if(jumble){data=random(200);} writeIndex++;return((data));
}
