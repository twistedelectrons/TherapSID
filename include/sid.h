...
/*
  ...
  - a changed offset permanently shifts its original offset value (+/-) and can also be increased or decreased by factor 3
  ...
  - the following calibration workflow can be used with these hotkeys:
    - enter "filter setup mode": long-pressed ARP MODE + LFO CHAIN button; indicated by "FC" and LFO LEDs flash for available SIDs
    ...
    - reset calibration: pushed RESET button resets any calibration, while long pressed stores and exits setup; indicated by "rC"
